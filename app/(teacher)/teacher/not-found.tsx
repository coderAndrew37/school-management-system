// app/(teachers)/not-found.tsx

import { GraduationCap, FileQuestion, MoveLeft } from "lucide-react";
import Link from "next/link";

export default function TeacherGlobalNotFound() {
  return (
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-xl p-8 space-y-5 shadow-2xl">
          ...
          <div>
            ...
            <p className="text-xs text-white/50 leading-relaxed max-w-xs mx-auto">
              The student record, assignment file, or class page you are trying to view does not exist or has been relocated.
            </p>
          </div>
