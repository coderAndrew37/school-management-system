// app/(parents)/not-found.tsx

import { GraduationCap, HelpCircle, MoveLeft } from "lucide-react";
import Link from "next/link";

export default function ParentGlobalNotFound() {
  return (
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-xl p-8 space-y-5 shadow-2xl">
          ...
          <div>
            ...
            <p className="text-xs text-white/50 leading-relaxed max-w-xs mx-auto">
              The dashboard page, document link, or profile card you are trying to look at is no longer available or may have moved.
            </p>
          </div>
